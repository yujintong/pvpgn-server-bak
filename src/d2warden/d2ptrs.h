...
#ifdef D2_1_13_d
// D2NET ptrs
D2FUNCPTR(D2NET, SendPacket, void __stdcall, (DWORD unk1,DWORD ClientID,unsigned char *ThePacket,DWORD PacketLen), -10012)
// by marsgod D2Game
D2FUNCPTR(D2GAME, GetClient_I, DWORD __fastcall, (DWORD ClientID), 0x6FCDC790)
D2FUNCPTR(D2GAME, LeaveCriticalSection_I, void __stdcall, (DWORD ClientID), 0x6FCDB8E0)
D2FUNCPTR(D2GAME, Send0XAEPacket_I, DWORD __fastcall, (void *ptPlayer,DWORD Length,DWORD *Packet), 0x6FCFB8D0)
D2FUNCPTR(D2GAME, SendPacket_I, DWORD __fastcall, (DWORD *ptClient,unsigned char *Packet,DWORD Length), 0x6FCFB780)
D2FUNCPTR(D2GAME, KickCharFromGame, DWORD __stdcall, (DWORD ClientID), -10019)
D2FUNCPTR(D2GAME, GameFindUnitFunc_I, DWORD __fastcall, (DWORD ptGame, DWORD dwUnitType, DWORD dwUnitId), 0x6FC8DC40)

D2FUNCPTR(D2NET, GetClient, DWORD __stdcall, (DWORD ClientID), -10019)
#endif
